...
**`Frontend Engineer Reactjs,Nextjs`** · `Backend Engineer Nodejs(Growing)` · `Full-Stack Engineer(Growing)` · `Embedded Systems Software Engineer` · `Computer Engineering Background`
